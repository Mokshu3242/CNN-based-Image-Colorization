...
CHECKPOINT_DIR = "checkpoints/checkpoints_simpleunet"
RESULTS_DIR = "results/results_simpleunet"
...
class SimpleUNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.dec3 = make_decoder_block(512, 256) 
        self.up2 = nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2)
        self.dec2 = make_decoder_block(256, 128)  
        self.up1 = nn.ConvTranspose2d(128, 64, kernel_size=2, stride=2)
        self.dec1 = make_decoder_block(128, 64) 
    ...
    def forward(self, x):
        ...
        output = self.tanh(self.output_layer(d1))
        return output
...
def train(resume=False):
    print("=" * 50)
    print("Simple U-Net - Image Colorization")
    ...
    plt.xlabel('Epoch')
    plt.ylabel('L1 Loss')
    plt.title('Simple U-Net - Training and Validation Loss')
    plt.legend()
    plt.grid(alpha=0.3)
    plt.tight_layout()
